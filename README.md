...
- `VirtualBox`, tested with Version 5.1.18 r114002 and 5.1.28 r117968
...
```
git clone http://github.com/at1984z/k8s-playground
```
...
etcd-k8s1                        1/1       Running             0          10m       172.42.42.101   k8s1
kube-apiserver-k8s1              1/1       Running             1          10m       172.42.42.101   k8s1
kube-controller-manager-k8s1     1/1       Running             0          11m       172.42.42.101   k8s1
kube-discovery-982812725-pv5ib   1/1       Running             0          11m       172.42.42.101   k8s1
kube-dns-2247936740-cucu9        0/3       ContainerCreating   0          10m       <none>          k8s1
kube-proxy-amd64-kt8d6           1/1       Running             0          10m       172.42.42.101   k8s1
kube-proxy-amd64-o73p7           1/1       Running             0          5m        172.42.42.103   k8s3
kube-proxy-amd64-piie9           1/1       Running             0          8m        172.42.42.102   k8s2
kube-scheduler-k8s1              1/1       Running             0          11m       172.42.42.101   k8s1
```
...
$ kubectl -n kube-system get po -o wide
NAME                             READY     STATUS    RESTARTS   AGE       IP              NODE
etcd-k8s1                        1/1       Running   0          14m       172.42.42.101   k8s1
kube-apiserver-k8s1              1/1       Running   1          13m       172.42.42.101   k8s1
kube-controller-manager-k8s1     1/1       Running   0          14m       172.42.42.101   k8s1
kube-discovery-982812725-pv5ib   1/1       Running   0          14m       172.42.42.101   k8s1
kube-dns-2247936740-cucu9        3/3       Running   0          14m       10.40.0.1       k8s1
kube-proxy-amd64-kt8d6           1/1       Running   0          13m       172.42.42.101   k8s1
kube-proxy-amd64-o73p7           1/1       Running   0          8m        172.42.42.103   k8s3
kube-proxy-amd64-piie9           1/1       Running   0          11m       172.42.42.102   k8s2
kube-scheduler-k8s1              1/1       Running   0          14m       172.42.42.101   k8s1
weave-net-33rjx                  2/2       Running   0          3m        172.42.42.102   k8s2
weave-net-3z7jj                  2/2       Running   0          3m        172.42.42.101   k8s1
weave-net-uvv48                  2/2       Running   0          3m        172.42.42.103   k8s3
```
